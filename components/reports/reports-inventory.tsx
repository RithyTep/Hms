  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Generate reports about medication and supply inventory</CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            ...
            <Select value={reportType} onValueChange={setReportType}>
              ...
              <SelectContent>
                <SelectItem value="stock">Current Stock Report</SelectItem>
                <SelectItem value="expiry">Expiry Report</SelectItem>
                <SelectItem value="usage">Usage Report</SelectItem>
                <SelectItem value="orders">Order History Report</SelectItem>
              </SelectContent>
            </Select>
          </div>
