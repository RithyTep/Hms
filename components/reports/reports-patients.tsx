...
export function ReportsPatients() {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Generate reports about patient statistics and demographics</CardDescription>
      </CardHeader>
          ...
          <div className="space-y-2">
            ...
            <Select value={reportType} onValueChange={setReportType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="discharges">Discharges Report</SelectItem>
                <SelectItem value="demographics">Demographics Report</SelectItem>
                <SelectItem value="diagnoses">Common Diagnoses Report</SelectItem>
              </SelectContent>
            </Select>
          </div>
