  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Generate reports about staff performance and scheduling</CardDescription>
      </CardHeader>
          ...
          <div className="space-y-2">
            ...
            <Select value={reportType} onValueChange={setReportType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="scheduling">Scheduling Report</SelectItem>
